...
export const ITINERARY: DayEntry[] = [
  ...
  },
  {
    ...
    flights: [
      ...
      },
      {
        ...
        arrive: '15:20',
        type: 'commercial',
        note: 'Jon & Stefanie only. Colossal Aviapartner meet & greet at arrivals.',
      },
    ],
  ...
  },
  {
    ...
    activities: [
      ...
      'Jon & Stefanie: Turkish Airlines departs JNB 18:00 → Washington Dulles (IAD). Check in by 15:00.',
    ...
    flights: [
      ...
      },
      {
        ...
        arrive: 'Next morning',
        type: 'commercial',
        note: 'Jon & Stefanie only. Check in by 15:00. Departs OR Tambo international terminal.',
      },
      {
    ...
    notes: [
      ...
      'Jon & Stefanie depart on Turkish Airlines at 18:00 (JNB → IAD).',
